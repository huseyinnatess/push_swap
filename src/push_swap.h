...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/25 13:33:44 by fduvan            #+#    #+#             */
/*   Updated: 2023/12/20 17:57:27 by huates           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	create_stacks(t_stacks *stack_a, int argc);
void	init_stacks(int arc, char **args, t_stacks *st);

int		*ft_reverse_stack1(int arr_len, int *arr);
